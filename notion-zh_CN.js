...
(function() {
  ...
  I18n.install('zh', {
    ...
    'Personal info': '个人资讯',
    'Change email': '更换邮箱',
    'Log out of all devices': '从所有装置登出',
    'You will be logged out of all other active sessions besides this one and will have to log back in.': '您将立即登出其他所有上线装置，并且必须重新登入。',
    'Log out': '登出',
    'Danger zone': '危险区域',
    ...
    'Notifications': '通知',
    'Mobile push notifications': '行动装置推送通知',
    ...
    'Learn about mobile and desktop notifications': '了解关于行动装置和桌面应用程式通知',
    ...
    'Learn about adding members to your workspace': '了解更多关于在工作区新增成员的资讯。',
    ...
    'Learn how to use database views': '了解如何使用资料库视图',
    ...
    'Design': '设计',
    'Roadmap': '地图',
    'User Research Database': '使用者研究资料库',
    'Design Tasks': '设计任务',
    'Meeting Notes': '会议笔记',
    'Design System': '设计系统',
    'Education': '教育',
